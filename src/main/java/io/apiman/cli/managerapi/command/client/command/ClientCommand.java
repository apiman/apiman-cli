 ...
 */
@Parameters(commandDescription = "Manage Clients")
public class ClientCommand extends AbstractManagerCommand {

    @Inject
    public ClientCommand(ManagementApiService managementApiService) {
