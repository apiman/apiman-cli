...
@Parameters(commandDescription = "Manage Client policies")
public class ClientPolicyCommand extends AbstractManagerCommand {
    @Inject
    public ClientPolicyCommand(ManagementApiService managementApiService) {
        super(managementApiService);
    }

    @Override
    protected void populateCommands(Map<String, Class<? extends Command>> commandMap) {
        commandMap.put("add", ClientPolicyAddCommand.class);
    }
