...
@Parameters(commandDescription = "Manage Plan policies")
public class PlanPolicyCommand extends AbstractManagerCommand {
    @Inject
    public PlanPolicyCommand(ManagementApiService managementApiService) {
        super(managementApiService);
    }

    @Override
    protected void populateCommands(Map<String, Class<? extends Command>> commandMap) {
        commandMap.put("add", PlanPolicyAddCommand.class);
    }
