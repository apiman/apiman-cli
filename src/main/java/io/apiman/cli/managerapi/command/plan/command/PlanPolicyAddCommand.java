...
public class PlanPolicyAddCommand extends AbstractPlanCommand {
    private static final Logger LOGGER = LogManager.getLogger(PlanPolicyAddCommand.class);
    ...
    @Inject
    public PlanPolicyAddCommand(ManagementApiService managementApiService) {
    ...
    public void performFinalAction(JCommander parser) throws CommandException {
        ...
        LOGGER.debug("Adding policy '{}' to Plan '{}' with configuration: {}",
